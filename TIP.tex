...
\begin{document}
	...
	\begin{itemize}
		\item użytkownik łączy się z systemem jedynie za pomocą nazwy użytkownika oraz adres IP serwera,
		...
		\item użytkownik, który założył pokój, może wyrzucić innych użytkowników z pokoju.
	\end{itemize}
	...
	\begin{itemize}
		...
		\item do połączenia z serwerem nie jest potrzebna rejestracja użytkownika, jedynym wymogiem jest podanie nazwy użytkownika oraz adres IP serwera,
		\item do składowania haseł zabezpieczających pokoje, posłuży relacyjna baza danych PostgreSQL,
	...
	\end{itemize}
	\paragraph*{} Hasła wraz z potrzebnymi informacjami o pokojach oraz użytkownikach są przetrzymywane w relacyjnej bazie danych PostgreSQL, działającej w chmurze.
