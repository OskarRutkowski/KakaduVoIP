...
\begin{document}
	...
	\begin{itemize}
		...
		\item javax.crypto - biblioteka wykorzystana do nakładania funkcji skrótu na hasła,
		\item javax.security - biblioteka wykorzystana do szyfrowania głosu.
	\end{itemize}
	\paragraph*{} Hasła są przetrzymywane w relacyjnej bazie danych PostgreSQL, działającej w chmurze.
	\paragraph*{} Użyte kodeki, zawarte w JMF:\\ MPEG Layer II Audio (.mp2) [MPEG layer 1, 2 audio ]
\end{document}